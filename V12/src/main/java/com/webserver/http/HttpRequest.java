...
public class HttpRequest {
   ...
   private Socket socket;
    ...
    private void parseUri(){
        ...
        queryString这个属性。
        然后再将queryString(uri中的参数部分）进行进一步拆分，来的到每一组参数。
        首先将queryString按照“&”拆分出来每一组参数，然后每组参数在按照“=”拆分为参数名与参数值
        之后将参数名作为key，参数值作为key，参数作为value保存到parameters这个Map中保存即可，
        ...
        */
        ...
        System.out.println("rparameters"+parameters);
